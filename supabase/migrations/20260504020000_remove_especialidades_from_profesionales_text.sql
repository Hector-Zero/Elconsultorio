-- ─────────────────────────────────────────────────────────────────────────────
-- Migration: remove especialidades from profesionales_text
-- ─────────────────────────────────────────────────────────────────────────────
-- The bot was mentioning specialties unprompted when offering professional
-- choice. Specialties (and other professional details like bio, education,
-- photo) belong on the public profile page, not in the bot's chat flow.
-- The bot should mention only the professional's name.
--
-- This migration updates profesionales_text to drop the "Especialidades:"
-- line. The full profesionales array is unchanged (dashboard and public
-- URL still get the rich data).
-- ─────────────────────────────────────────────────────────────────────────────
